...
#[derive(Debug)]
pub struct Book {
    pub guid: GUID, //guid is the GUID for this book.
    pub root_account_guid: GUID, //rootAccountGuid is the root account GUID for this book.
    pub root_template_guid: GUID,//rootTemplateGuid is the root template's GUID.
